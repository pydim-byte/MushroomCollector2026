...
class RunningMushroom(DynamicObject):
    ...
    def set_direction(self, direction="away_from_player") -> pygame.Vector2:
    ...
    def fixed_update(self) -> None:
        self.rect.clamp_ip(0, 40, GameScreen.SCREEN_WIDTH, GameScreen.SCREEN_HEIGHT - 40)
        super().fixed_update()
